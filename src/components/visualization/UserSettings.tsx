    ...
    <Modal visible={true} transparent>
      <TouchableWithoutFeedback onPress={props.closeSettings}>
        <View
          style={[
            styles.modalOverlay,
            {
              width: getModalWidth(orientation),
              height: getModalHeight(orientation),
            },
          ]}
        />
      </TouchableWithoutFeedback>
      <View
        style={[
          ...
          {
            top:
              (getModalHeight(orientation) - getItemHeight(orientation)) / 1.8,
          },
        ]}>
        <View
          style={[
            ...
            {
              width: getItemWidth(orientation),
              height: 300,
            },
          ]}>
          ...
          <View style={styles.randomArray}>
            <Text style={styles.arrayForSortText}>{props.arrayForSort}</Text>
          </View>
          <View style={styles.center}>
            ...
            <TouchableOpacity onPress={saveTimer}>
              <Text style={styles.timerButtonText}>Save timer</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
